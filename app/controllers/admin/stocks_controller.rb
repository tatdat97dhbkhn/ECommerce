...
class Admin::StocksController < AdminController
  ...
  def create
    ...
    respond_to do |format|
      if @admin_stock.save
        format.html { redirect_to admin_product_stock_url(@product, @admin_stock), notice: t('common.notice.success') }
  ...
  def update
    respond_to do |format|
      if @admin_stock.update(admin_stock_params)
        format.html do
          redirect_to admin_product_stock_url(@admin_stock.product, @admin_stock), notice: t('common.notice.success')
        end
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to admin_product_stocks_url, notice: t('common.notice.success') }
