...
class Admin::ProductsController < AdminController
  ...
  def create
    ...
    respond_to do |format|
      if @admin_product.save
        format.html { redirect_to admin_product_url(@admin_product), notice: t('common.notice.success') }
  ...
  def update
    ...
    if @admin_product.update(admin_product_params.reject { |k| k['images'] })
      ...
      redirect_to admin_products_path, notice: t('common.notice.success')
    else
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to admin_products_url, notice: t('common.notice.success') }
