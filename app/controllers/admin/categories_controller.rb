...
class Admin::CategoriesController < AdminController
  ...
  def create
    ...
    respond_to do |format|
      if @admin_category.save
        format.html { redirect_to admin_category_url(@admin_category), notice: t('common.notice.success') }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to admin_categories_url, notice: t('common.notice.success') }
