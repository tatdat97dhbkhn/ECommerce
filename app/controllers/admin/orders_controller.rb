...
class Admin::OrdersController < AdminController
  ...
  def index
    ...
    @fulfilled_pagy, @fulfilled_orders = pagy(
      Order.where(fulfilled: true).order(created_at: :asc),
  ...
  def create
    ...
    respond_to do |format|
      if @admin_order.save
        format.html { redirect_to admin_order_url(@admin_order), notice: t('common.notice.success') }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to admin_orders_url, notice: t('common.notice.success') }
